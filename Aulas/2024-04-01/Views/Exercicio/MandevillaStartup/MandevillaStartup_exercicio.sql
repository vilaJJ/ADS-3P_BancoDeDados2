...
GROUP BY
    P.Codigo
ORDER BY
    P.Titulo ASC, U.Nome ASC, P.ValorArrecadado DESC;
...
GROUP BY
    I.Codigo
ORDER BY
    P.Titulo ASC, U.Nome ASC, I.Valor DESC;
...
GROUP BY
    CP.Codigo
ORDER BY
    CP.Nome ASC, COUNT(P.Codigo) DESC;
...
GROUP BY
    E.Codigo
ORDER BY
    E.Titulo ASC, COUNT(PE.Usuario_Codigo) DESC;
...
GROUP BY
    U.Codigo
ORDER BY
    SUM(I.Valor) DESC, U.Nome ASC LIMIT 5;
...
GROUP BY
    AP.Codigo
ORDER BY
    AP.DataAnalise ASC, P.Titulo ASC, U.Nome ASC, AP.Comentarios ASC, AP.Nota DESC;
